...
public class ExpressionParser extends Parser {
    ...
    public static class EquationContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitEquation(this);
    ...
    public static class FactorContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitFactor(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Signed_composed_atomContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_signed_composed_atom;
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitSigned_composed_atom(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Composed_atomContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitComposed_atom(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Expr_in_bracketsContext extends ParserRuleContext {
        public TerminalNode L_ROUND_BR() {
            return getToken(ExpressionParser.L_ROUND_BR, 0);
        }
        ...
        public TerminalNode R_ROUND_BR() {
            return getToken(ExpressionParser.R_ROUND_BR, 0);
        }

        public TerminalNode L_SQUARE_BR() {
            return getToken(ExpressionParser.L_SQUARE_BR, 0);
        }

        public TerminalNode R_SQUARE_BR() {
            return getToken(ExpressionParser.R_SQUARE_BR, 0);
        }

        public TerminalNode L_FIGURE_BR() {
            return getToken(ExpressionParser.L_FIGURE_BR, 0);
        }

        public TerminalNode R_FIGURE_BR() {
            return getToken(ExpressionParser.R_FIGURE_BR, 0);
        }

        public List<TerminalNode> ABS_BR() {
            return getTokens(ExpressionParser.ABS_BR);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitExpr_in_brackets(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NumberContext extends ParserRuleContext {
        public TerminalNode SCIENTIFIC_NUMBER() {
            return getToken(ExpressionParser.SCIENTIFIC_NUMBER, 0);
        }

        public TerminalNode FLOAT_NUMBER() {
            return getToken(ExpressionParser.FLOAT_NUMBER, 0);
        }

        public TerminalNode INT_NUMBER() {
            return getToken(ExpressionParser.INT_NUMBER, 0);
        }
    ...
    public static class LexemContext extends ParserRuleContext {
        public TerminalNode LEXEM() {
            return getToken(ExpressionParser.LEXEM, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitLexem(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RelopsContext extends ParserRuleContext {
        ...
        public TerminalNode GE() {
            return getToken(ExpressionParser.GE, 0);
        }

        public TerminalNode LE() {
            return getToken(ExpressionParser.LE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitRelops(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Lowest_priorityContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitLowest_priority(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Low_priorityContext extends ParserRuleContext {
        ...
        public TerminalNode DIV() {
            return getToken(ExpressionParser.DIV, 0);
        }

        public TerminalNode DOT_OP() {
            return getToken(ExpressionParser.DOT_OP, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitLow_priority(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Middle_priorityContext extends ParserRuleContext {
        public TerminalNode POW() {
            return getToken(ExpressionParser.POW, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitMiddle_priority(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Unary_leftContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitUnary_left(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Unary_rightContext extends ParserRuleContext {
        public TerminalNode FACTORIAL() {
            return getToken(ExpressionParser.FACTORIAL, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor)
                return ((ExpressionVisitor<? extends T>) visitor).visitUnary_right(this);
            else return visitor.visitChildren(this);
        }
    }
